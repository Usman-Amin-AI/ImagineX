...
LABEL org.opencontainers.image.title="ImagineX"
LABEL org.opencontainers.image.description="A maintained fork of Fooocus with API, queueing, safety, and container support"
LABEL org.opencontainers.image.vendor="ImagineX"
...
ENTRYPOINT ["/bin/bash", "/content/entrypoint.sh"]
CMD ["--listen"]

...
# Headless API mode (no Gradio UI)
args_parser.parser.add_argument("--api", action='store_true', help="Run in headless API mode (no Gradio).")
args_parser.parser.add_argument("--backend", type=str, default=None,
                                help="Select generation backend: sdxl (default) or flux.")
...
# Backend selection should be applied early; default remains SDXL.
if args_parser.args.backend is not None:
    import modules.backends as backends
    backends.set_backend(args_parser.args.backend)
